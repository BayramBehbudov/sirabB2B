import { GetNotificationTemplates } from "@/api/Notification";
  ...
  return (
    <Fragment>
      <div className="flex flex-col gap-1">
        <label className="font-semibold">{t("notificationTemplate")}:</label>
        <button
          ref={btnRef}
        ...
        >
          ...
          >
            {value?.length > 0
              ? t("templateSelectedCount", { count: value?.length })
              : t("selectTemplate")}
          </span>
      ...
      <Dialog
        ...
        header={
          <p className={`text-[1.5rem] font-bold`}>
            {selected.length > 0
              ? t("templateSelectedCount", { count: selected.length })
